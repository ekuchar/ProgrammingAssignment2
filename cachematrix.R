...
## Usage:
## 1) Create matrix cache using makeCacheMatrix.
## 2) Set cached matrix by set() method.
## 3) When inverse of the matrix is required it is returned by cacheSolve.
## 4) To get/inspect cached matrix use get()
## 5) To set another cached matrix use set(matr)
##
## Example:
